 ...
 * @param <DATA>
 */
public class LoadingViewUltraHelper<DATA> extends LoadingViewHelper<DATA> {

    public LoadingViewUltraHelper(PtrClassicFrameLayout ptrClassicFrameLayout) {
        super(new RefreshView(ptrClassicFrameLayout));
    }

    public LoadingViewUltraHelper(PtrClassicFrameLayout ptrClassicFrameLayout, ILoadView loadView, ILoadMoreView loadMoreView) {
