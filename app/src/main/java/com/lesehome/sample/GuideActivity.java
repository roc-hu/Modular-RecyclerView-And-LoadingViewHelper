...
import com.lesehome.sample.adapter.GuideAdapter;
...
public class GuideActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initViews() {
        ...
        views.add(inflater.inflate(R.layout.item_guide_three, null));
        views.add(inflater.inflate(R.layout.item_guide_four, null));
