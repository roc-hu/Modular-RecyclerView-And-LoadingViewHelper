...
import com.lesehome.carrot.recycler.StickyHeaderAdapter;
...
public class InlineStickyTestAdapter
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        final View view = mInflater.inflate(R.layout.stickyheaders_item_inline_test, viewGroup, false);
    ...
    public HeaderHolder onCreateHeaderViewHolder(ViewGroup parent) {
        final View view = mInflater.inflate(R.layout.stickyheaders_header_inline_test, parent, false);
